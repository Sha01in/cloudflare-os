...
class AiGateway extends RpcTarget {
  async getLog() {
    // Standalone workerd has no Cloudflare AI Gateway usage ledger or hosted billing.
    // Explicitly reject rather than returning a fake cost: 0.
    throw new Error(
      "AI Gateway accounting and cost logging are not supported in standalone workerd. " +
      "Configure direct BYOK / SuperGrok provider credentials."
    );
  }
}
